...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    Pose2d nine = new Pose2d(new Translation2d(1, 2), Rotation2d.fromDegrees(0));
     ...
     twoP = new PathPoint(two, 1, 1);
     threeP = new PathPoint(three,  1, 1);
     fourP = new PathPoint(four, 1, 0.5);
    PathPoint fiveP = new PathPoint(five, 1, 0.5);
    PathPoint sixP = new PathPoint(six, 1, 0.5);
    PathPoint sevenP = new PathPoint(seven, 1, 0.5);
  ...
  public Command getAutonomousCommand() {
    ...
    }).andThen(new FollowPath(pathgen.generatePathPointArray(), 1, 20/50., chassis, chassis::setVelocities, chassis::getPose,
    chassis::getVelocity));
  }
}
